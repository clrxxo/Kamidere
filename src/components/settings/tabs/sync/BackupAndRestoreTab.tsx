    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Import and export your {BRAND_NAME} settings as a JSON file. This lets you move your setup to another device or recover it after reinstalling {BRAND_NAME} or Discord.
            </Paragraph>
