    ...
    return (
        <>
            <ModalContent className={cl("root")}>
                ...
                {plugins.length ? (
                    <Paragraph>
                        {user.username} has {ContributedHyperLink} to {pluralise(plugins.length, "plugin")} in {BRAND_NAME}!
                    </Paragraph>
                ) : (
                    <Paragraph>
                        {user.username} has not made any plugins. They likely {ContributedHyperLink} in other ways for {BRAND_NAME}!
                    </Paragraph>
                )}
