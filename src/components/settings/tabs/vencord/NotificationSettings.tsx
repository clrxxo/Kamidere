    ...
    return (
        <section className={Margins.top16}>
            ...
            <Paragraph className={Margins.bottom8}>
                Settings for notifications sent by {BRAND_NAME}.
    ...
    return (
        <div style={{ padding: "1em 0" }}>
            ...
            <Paragraph className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>{BRAND_NAME} Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: `Always use ${BRAND_NAME} notifications`, value: "never" },
            ...
            <FormSwitch
                title="Show a summary notification when Discord regains focus"
