...
import { BRAND_DONATE_URL, BRAND_TRANSLATE_URL, UPSTREAM_DONATE_URL } from "@shared/branding";
...
export function DonateButton({
    ...
    className,
    ...props
}: Partial<ButtonProps> & { brand?: boolean; }) {
    const link = brand ? BRAND_DONATE_URL : UPSTREAM_DONATE_URL;
    return (
        <Button
            {...props}
            variant="none"
...
export function TranslateButton({
    ...
    const link = BRAND_TRANSLATE_URL;
    return (
        <Button
            {...props}
            variant="none"
