    ...
    handleCrash(_this: any, errorState: any) {
        ...
        setTimeout(() => {
            ...
            try {
                if (!hasCrashedOnce) {
                    hasCrashedOnce = true;
                    maybePromptToUpdate(`Uh oh, Discord has just crashed... but there is a ${BRAND_NAME} update available that might fix this issue. Would you like to update now?`, true);
                }
            } catch { }
