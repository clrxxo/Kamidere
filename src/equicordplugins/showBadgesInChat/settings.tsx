...
import { BRAND_DONOR_BADGE_PREVIEW_URL, BRAND_ICON_DATA_URL, BRAND_NAME } from "@shared/branding";
...
const settings = definePluginSettings({
    showEquicordDonor: {
        ...
        description: `Enable to show ${BRAND_NAME} donor badges in chat.`,
        hidden: true,
        default: true
    },
    EquicordDonorPosition: {
        type: OptionType.NUMBER,
        description: `The position of the ${BRAND_NAME} donor badges.`,
        hidden: true,
        default: 0
    },
    showEquicordContributor: {
        type: OptionType.BOOLEAN,
        description: `Enable to show ${BRAND_NAME} contributor badges in chat.`,
        hidden: true,
        default: true
    },
    EquicordContributorPosition: {
        type: OptionType.NUMBER,
        description: `The position of the ${BRAND_NAME} contributor badge.`,
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: BRAND_DONOR_BADGE_PREVIEW_URL, shown: settings.store.showEquicordDonor, title: `${BRAND_NAME} donor badges`, key: "EquicordDonor", position: settings.store.EquicordDonorPosition },
        { src: BRAND_ICON_DATA_URL, shown: settings.store.showEquicordContributor, title: `${BRAND_NAME} contributor badge`, key: "EquicordContributer", position: settings.store.EquicordContributorPosition },
